...
6. **Verify Routing:** Connect via SSH to each node and verify the Yggdrasil peer list to ensure it has strictly established a link ONLY with its immediate neighbor(s), guaranteeing no hop-skipping.
...
| --- | --- | --- | --- | --- |
| Phone1 -> LTE | - | 22.7 Mbit/s / 3.4 Mbit/s / 338 ms | 149 Mbit/s / 3.19 Mbit/s / 21 ms | 2160p |
